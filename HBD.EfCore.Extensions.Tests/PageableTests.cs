...
namespace HBD.EfCore.Extensions.Tests
{
    ...
    public class PageableTests
    {
        ...
        public async Task ForPageSpecAsync()
        {
            ...
            var result = await UnitTestSetup.Db.ForPageSpecAsync(new PageableSpec<User>(1, 10, i => i.FirstName)).ConfigureAwait(false);
        ...
        public async Task ForPageSpecAsync_Desc()
        {
            ...
            var result = await UnitTestSetup.Db.ForPageSpecAsync(new PageableSpec<User>(1, 10, i => i.FirstName, OrderingDirection.Desc)).ConfigureAwait(false);
        ...
        public async Task ForPageSpecAsync_WithSpec()
        {
            ...
            var result = await UnitTestSetup.Db.ForPageSpecAsync(new PageableSpec<User>(1, 10, i => i.FirstName, spec: new UserIdGreaterThan10Spec())).ConfigureAwait(false);
        ...
        {
            var result = await UnitTestSetup.Db.Set<User>().OrderBy(u => u.Id).ToPageableAsync(-1, 100).ConfigureAwait(false);
        }
        ...
        {
            var result = await UnitTestSetup.Db.Set<User>().OrderBy(u => u.Id).ToPageableAsync(0, 0).ConfigureAwait(false);
        }
        ...
        public async Task TesAsync()
        {
            ...
            var result = await UnitTestSetup.Db.Set<User>().OrderBy(u => u.Id).ToPageableAsync(0, 100).ConfigureAwait(false);

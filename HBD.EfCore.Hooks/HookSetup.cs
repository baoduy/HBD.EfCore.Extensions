...
namespace Microsoft.EntityFrameworkCore
{
    public static class HookSetup
    {
        ...
        /// <returns></returns>
        public static IServiceCollection AddDbContextPoolWithHooks<TContext>(this IServiceCollection serviceCollection, Action<SetupOptions> hookOptions, Action<DbContextOptionsBuilder> dbContextOptions = null,
            int poolSize = 128)
        ...
        /// <returns></returns>
        public static IServiceCollection AddDbContextWithHooks<TContext>(this IServiceCollection serviceCollection, Action<SetupOptions> hookOptions, Action<DbContextOptionsBuilder> dbContextOptions = null,
                    ...
                    Action<SetupOptions> hookOptions)
        {
            ...
            if (setupOptions.Trigger)
            {
                ...
                globalServiceCollection.UseTriggerProfiles(setupOptions.Assemblies.ToArray());
                builder.UseHooks(op => op.Add<TriggerHook>());
            }

            builder.UseHooks(op => op.ScanFrom(setupOptions.Assemblies.ToArray()));
            return setupOptions;
        }

        private static IServiceInjectionExtension GetServiceInjectionExtension(this DbContextOptionsBuilder optionsBuilder)
        {
        ...
        /// <returns></returns>
        private static DbContextOptionsBuilder UseHooks(this DbContextOptionsBuilder @this, Action<HookOptions> options)
        {
